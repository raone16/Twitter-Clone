    ...
    render() {
        ...
        return (
                ...
                <View style={styles.container}>
                    <Image style={{height:55, width:50  }}source={require("../images/pp.png")} />
                    <Text style ={{fontSize: 18,fontWeight: 'bold'}}>Raveena S{'                 '}
                        <Entypo name='chevron-small-down' style={{fontSize: 25, fontWeight: 'bold',color: '#00aced'}}/></Text>
                    <Text style ={{fontSize: 15,color:'grey'}}>@RaveenaSenthilvel</Text>
                    <Text>{"\n"}</Text>
                    <Text>
                        <Text>
                            <Text style ={styles.follow}>500{' '}</Text>
                            <Text style ={styles.followText}>Following </Text>
                        </Text>{'    '}
                        <Text>
                            <Text style ={styles.follow}>320</Text>{' '}
